...
const AboutPage = () => {
  return (
    <div className='orange__gradient'>  
    <Navbar/>
      ...
      >
        <div className="max-w-lg">
          <p className="text-lg mb-4">At HealthSphere, our mission is to empower individuals to take control of their health and well-being.</p>
        ...
        <div className="ml-0 md:ml-8">
          <img src="/about.jpg" alt="About Us" className="w-full  md:max-w-xs rounded-lg shadow-md" />
        </div>
      </div>
    </div>
    </div>
